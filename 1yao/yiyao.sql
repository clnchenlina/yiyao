...
-- 数据库: `books`
--
CREATE DATABASE `books` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `books`;
...
CREATE TABLE IF NOT EXISTS `advertising` (
  `advertisingid` int(11) NOT NULL AUTO_INCREMENT,
  `advertisingclassify` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `advertisingurl` (
  `advertisingurlid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `imgurl9` varchar(255) DEFAULT NULL,
  `imgurl10` varchar(255) DEFAULT NULL,
  `advertisingid` int(11) DEFAULT NULL,
  PRIMARY KEY (`advertisingurlid`),
  KEY `advertisingid` (`advertisingid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- 转存表中的数据 `advertisingurl`
--
...
CREATE TABLE IF NOT EXISTS `books` (
  ...
  `sellnum` int(11) unsigned zerofill NOT NULL,
  `times` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `booksimgurl` (
  `imgurlid` int(11) NOT NULL AUTO_INCREMENT,
  `imgurl1` varchar(255) DEFAULT NULL,
  `imgurl2` varchar(255) DEFAULT NULL,
  `imgurl3` varchar(255) DEFAULT NULL,
  `imgurl4` varchar(255) DEFAULT NULL,
...
--
-- 表的结构 `booksoneclassify`
--

CREATE TABLE IF NOT EXISTS `booksoneclassify` (
  `booksoneclassifyid` int(11) NOT NULL AUTO_INCREMENT,
  `classifyname` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`booksoneclassifyid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- 转存表中的数据 `booksoneclassify`
--
...
--
-- 表的结构 `bookstwoclassify`
--

CREATE TABLE IF NOT EXISTS `bookstwoclassify` (
  `bookstwoclassifyid` int(11) NOT NULL AUTO_INCREMENT,
  `classifyname` varchar(30) DEFAULT NULL,
  `booksoneid` int(11) DEFAULT NULL,
  PRIMARY KEY (`bookstwoclassifyid`),
  KEY `booksclassifyid` (`booksoneid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- 转存表中的数据 `bookstwoclassify`
--
...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  `booksnum` tinyint(4) DEFAULT NULL,
  `booksid` int(11) DEFAULT NULL,
  PRIMARY KEY (`cartid`),
  KEY `cbooksid` (`booksid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `uesrsex` varchar(4) DEFAULT NULL,
  `email` varchar(20) DEFAULT NULL,
  `usermoney` decimal(11,2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `evaluate` (
  ...
  KEY `ebooksid` (`booksid`),
  KEY `eusersid` (`usersid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `zprice` decimal(11,2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ordersmore` (
  `ordersmoreid` int(11) NOT NULL AUTO_INCREMENT,
  `booksid` int(11) DEFAULT NULL,
  `booknum` tinyint(4) DEFAULT NULL,
  `ordersid` int(11) DEFAULT NULL,
  PRIMARY KEY (`ordersmoreid`),
  KEY `obookisid` (`booksid`),
  KEY `oordersid` (`ordersid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `versions` (
  `versionsid` int(11) NOT NULL AUTO_INCREMENT,
  `versions1` varchar(20) DEFAULT NULL,
  `versions2` varchar(20) DEFAULT NULL,
  `versions3` varchar(20) DEFAULT NULL,
  `versions4` varchar(20) DEFAULT NULL,
  `booksid` int(11) DEFAULT NULL,
  PRIMARY KEY (`versionsid`),
  KEY `vbooksid` (`booksid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `acustomerid` FOREIGN KEY (`customerid`) REFERENCES `customer` (`customerid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `advertisingurl`
--
ALTER TABLE `advertisingurl`
  ADD CONSTRAINT `advertisingid` FOREIGN KEY (`advertisingid`) REFERENCES `advertising` (`advertisingid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `booksimgurl`
--
ALTER TABLE `booksimgurl`
  ADD CONSTRAINT `booksid` FOREIGN KEY (`booksid`) REFERENCES `books` (`booksid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `bookstwoclassify`
--
ALTER TABLE `bookstwoclassify`
  ADD CONSTRAINT `booksclassifyid` FOREIGN KEY (`booksoneid`) REFERENCES `booksoneclassify` (`booksoneclassifyid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `cart`
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cbooksid` FOREIGN KEY (`booksid`) REFERENCES `books` (`booksid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `evaluate`
--
ALTER TABLE `evaluate`
  ADD CONSTRAINT `ebooksid` FOREIGN KEY (`booksid`) REFERENCES `books` (`booksid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `eusersid` FOREIGN KEY (`usersid`) REFERENCES `customer` (`customerid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `ordersmore`
--
ALTER TABLE `ordersmore`
  ADD CONSTRAINT `obookisid` FOREIGN KEY (`booksid`) REFERENCES `books` (`booksid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `oordersid` FOREIGN KEY (`ordersid`) REFERENCES `orders` (`ordersid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `tag`
--
ALTER TABLE `tag`
  ADD CONSTRAINT `bookid` FOREIGN KEY (`bookid`) REFERENCES `books` (`booksid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `versions`
--
ALTER TABLE `versions`
  ADD CONSTRAINT `vbooksid` FOREIGN KEY (`booksid`) REFERENCES `books` (`booksid`) ON DELETE CASCADE ON UPDATE CASCADE;
--
...
('def', 'books', 'address', 'addressid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'address', 'address', 2, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'address', 'phone', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'address', 'zip', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(6)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'address', 'customerid', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'advertising', 'advertisingid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'advertising', 'advertisingclassify', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertising', 'title', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertising', 'tag', 4, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'advertisingurlid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl1', 2, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl2', 3, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl3', 4, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl4', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl5', 6, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl6', 7, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl7', 8, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl8', 9, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl9', 10, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'imgurl10', 11, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'advertisingurl', 'advertisingid', 12, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'books', 'booksid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'books', 'price', 2, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'books', 'books', 'introduce', 3, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'books', 'autor', 4, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'books', 'sellnum', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned zerofill', '', '', 'select,insert,update,references', ''),
('def', 'books', 'books', 'times', 6, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'books', 'books', 'press', 7, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'books', 'language', 8, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'booksimgurl', 'imgurlid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'booksimgurl', 'imgurl1', 2, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'booksimgurl', 'imgurl2', 3, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'booksimgurl', 'imgurl3', 4, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'booksimgurl', 'imgurl4', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'booksimgurl', 'imgurl5', 6, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'booksimgurl', 'booksid', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'booksoneclassify', 'booksoneclassifyid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'booksoneclassify', 'classifyname', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'bookstwoclassify', 'bookstwoclassifyid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'bookstwoclassify', 'classifyname', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'bookstwoclassify', 'booksoneid', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'cart', 'cartid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'cart', 'usersid', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'cart', 'booksnum', 3, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'cart', 'booksid', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'customer', 'customerid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'customer', 'name', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'customer', 'username', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'customer', 'password', 4, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'customer', 'uesrsex', 5, NULL, 'YES', 'varchar', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(4)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'customer', 'email', 6, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'customer', 'usermoney', 7, NULL, 'YES', 'decimal', NULL, NULL, 11, 2, NULL, NULL, 'decimal(11,2)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'customer', 'paypwd', 8, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'evaluate', 'evaluateid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'evaluate', 'starlevel', 2, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'evaluate', 'times', 3, '0000-00-00 00:00:00', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', ''),
('def', 'books', 'evaluate', 'title', 4, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'evaluate', 'evaluate', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'evaluate', 'booksid', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'evaluate', 'usersid', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'orders', 'ordersid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'orders', 'userid', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'orders', 'zprice', 3, NULL, 'YES', 'decimal', NULL, NULL, 11, 2, NULL, NULL, 'decimal(11,2)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'ordersmore', 'ordersmoreid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'ordersmore', 'booksid', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'ordersmore', 'booknum', 3, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'ordersmore', 'ordersid', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'tag', 'tagid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'tag', 'tagname', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'tag', 'bookid', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'books', 'versions', 'versionsid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'books', 'versions', 'versions1', 2, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'versions', 'versions2', 3, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'versions', 'versions3', 4, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'versions', 'versions4', 5, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'books', 'versions', 'booksid', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'js1801', 'selected', 'id', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'js1801', 'selected', 'cont', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'js1801', 'user', 'userid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'js1801', 'user', 'uearpassword', 2, NULL, 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'js1801', 'user', 'username', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'js1801', 'user', 'useremail', 4, NULL, 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
...
('def', 'taobao', 'goods', 'goodsid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'taobao', 'goods', 'goodsname', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'taobao', 'goods', 'goodsprice', 3, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'taobao', 'goods', 'goodspic', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'taobao', 'goods', 'goodssales', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'books', 'booksid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
('def', 'test', 'books', 'booksname', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'books', 'booksprice', 3, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'test', 'books', 'booksclass', 4, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'books', 'booksinfo', 5, NULL, 'NO', 'varchar', 200, 600, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'classify', 'classifyid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(2) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'yiyao', 'classify', 'classifyname', 2, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'ggimg', 'ggimgid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'yiyao', 'ggimg', 'ggimggoods', 2, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'ggimg', 'ggimg', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'ggimg', 'classify', 4, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goods', 'goodsid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'yiyao', 'goods', 'goodsname', 2, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goods', 'classify', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goods', 'price', 4, NULL, 'YES', 'decimal', NULL, NULL, 6, 2, NULL, NULL, 'decimal(6,2)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goods', 'js', 5, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goods', 'imgid', 6, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goods', 'ggimg', 7, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goodsimg', 'imgid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'yiyao', 'goodsimg', 'img1', 2, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goodsimg', 'img2', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goodsimg', 'img3', 4, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goodsimg', 'img4', 5, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goodsimg', 'img5', 6, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goodsimg', 'img6', 7, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'goodsimg', 'goodsid', 8, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'sanclassify', 'sanclassifyid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
('def', 'yiyao', 'sanclassify', 'classifyname', 2, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'sanclassify', 'twoclassifyid', 3, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'twoclassify', 'classifyid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(2) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'yiyao', 'twoclassify', 'classifyname', 2, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'twoclassify', 'oneclassifyid', 3, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(2) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'users', 'userid', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'yiyao', 'users', 'password', 2, NULL, 'YES', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'yiyao', 'users', 'phone', 3, NULL, 'YES', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(11)', '', '', 'select,insert,update,references', '');
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '16'),
('CREATED_TMP_DISK_TABLES', '295'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '983'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_READ_KEY', '439'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '1046'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '7623'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '6067'),
('INNODB_BUFFER_POOL_PAGES_DATA', '444'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '11312'),
('INNODB_BUFFER_POOL_READS', '445'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '17'),
('INNODB_DATA_FSYNCS', '13'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '9474048'),
('INNODB_DATA_READS', '455'),
('INNODB_DATA_WRITES', '27'),
('INNODB_DATA_WRITTEN', '561664'),
...
('INNODB_OS_LOG_WRITTEN', '2560'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '0'),
('INNODB_PAGES_READ', '444'),
...
('INNODB_ROWS_READ', '137'),
('INNODB_ROWS_UPDATED', '0'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '14330'),
('KEY_BLOCKS_USED', '17'),
('KEY_READ_REQUESTS', '65'),
('KEY_READS', '17'),
...
('OPEN_FILES', '50'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '66'),
('OPEN_TABLES', '64'),
('OPENED_FILES', '2122'),
('OPENED_TABLE_DEFINITIONS', '66'),
('OPENED_TABLES', '566'),
...
('FT_MAX_WORD_LEN', '84'),
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.8\\data\\PC.pid'),
...
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.8\\data\\PC.log'),
('SQL_BIG_SELECTS', 'ON'),
...
('HAVE_GEOMETRY', 'YES'),
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.8\\data\\PC-slow.log'),
...
('def', 'books', 'PRIMARY', 'def', 'books', 'address', 'addressid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'acustomerid', 'def', 'books', 'address', 'customerid', 1, 1, 'books', 'customer', 'customerid'),
('def', 'books', 'PRIMARY', 'def', 'books', 'advertising', 'advertisingid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'PRIMARY', 'def', 'books', 'advertisingurl', 'advertisingurlid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'advertisingid', 'def', 'books', 'advertisingurl', 'advertisingid', 1, 1, 'books', 'advertising', 'advertisingid'),
('def', 'books', 'PRIMARY', 'def', 'books', 'books', 'booksid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'PRIMARY', 'def', 'books', 'booksimgurl', 'imgurlid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'booksid', 'def', 'books', 'booksimgurl', 'booksid', 1, 1, 'books', 'books', 'booksid'),
('def', 'books', 'PRIMARY', 'def', 'books', 'booksoneclassify', 'booksoneclassifyid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'PRIMARY', 'def', 'books', 'bookstwoclassify', 'bookstwoclassifyid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'booksclassifyid', 'def', 'books', 'bookstwoclassify', 'booksoneid', 1, 1, 'books', 'booksoneclassify', 'booksoneclassifyid'),
('def', 'books', 'PRIMARY', 'def', 'books', 'cart', 'cartid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'cbooksid', 'def', 'books', 'cart', 'booksid', 1, 1, 'books', 'books', 'booksid'),
('def', 'books', 'PRIMARY', 'def', 'books', 'customer', 'customerid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'PRIMARY', 'def', 'books', 'evaluate', 'evaluateid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'ebooksid', 'def', 'books', 'evaluate', 'booksid', 1, 1, 'books', 'books', 'booksid'),
('def', 'books', 'eusersid', 'def', 'books', 'evaluate', 'usersid', 1, 1, 'books', 'customer', 'customerid'),
('def', 'books', 'PRIMARY', 'def', 'books', 'orders', 'ordersid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'PRIMARY', 'def', 'books', 'ordersmore', 'ordersmoreid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'obookisid', 'def', 'books', 'ordersmore', 'booksid', 1, 1, 'books', 'books', 'booksid'),
('def', 'books', 'oordersid', 'def', 'books', 'ordersmore', 'ordersid', 1, 1, 'books', 'orders', 'ordersid'),
('def', 'books', 'PRIMARY', 'def', 'books', 'tag', 'tagid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'bookid', 'def', 'books', 'tag', 'bookid', 1, 1, 'books', 'books', 'booksid'),
('def', 'books', 'PRIMARY', 'def', 'books', 'versions', 'versionsid', 1, NULL, NULL, NULL, NULL),
('def', 'books', 'vbooksid', 'def', 'books', 'versions', 'booksid', 1, 1, 'books', 'books', 'booksid'),
('def', 'js1801', 'PRIMARY', 'def', 'js1801', 'selected', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'js1801', 'PRIMARY', 'def', 'js1801', 'user', 'userid', 1, NULL, NULL, NULL, NULL),
...
('def', 'taobao', 'PRIMARY', 'def', 'taobao', 'goods', 'goodsid', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'books', 'booksid', 1, NULL, NULL, NULL, NULL),
('def', 'yiyao', 'PRIMARY', 'def', 'yiyao', 'classify', 'classifyid', 1, NULL, NULL, NULL, NULL),
('def', 'yiyao', 'PRIMARY', 'def', 'yiyao', 'ggimg', 'ggimgid', 1, NULL, NULL, NULL, NULL),
('def', 'yiyao', 'goodsid', 'def', 'yiyao', 'ggimg', 'ggimggoods', 1, 1, 'yiyao', 'goods', 'goodsid'),
('def', 'yiyao', 'PRIMARY', 'def', 'yiyao', 'goods', 'goodsid', 1, NULL, NULL, NULL, NULL),
('def', 'yiyao', 'PRIMARY', 'def', 'yiyao', 'goodsimg', 'imgid', 1, NULL, NULL, NULL, NULL),
('def', 'yiyao', 'imggoodsid', 'def', 'yiyao', 'goodsimg', 'goodsid', 1, 1, 'yiyao', 'goods', 'goodsid'),
('def', 'yiyao', 'PRIMARY', 'def', 'yiyao', 'sanclassify', 'sanclassifyid', 1, NULL, NULL, NULL, NULL),
('def', 'yiyao', 'PRIMARY', 'def', 'yiyao', 'twoclassify', 'classifyid', 1, NULL, NULL, NULL, NULL),
('def', 'yiyao', 'oneclassifyid', 'def', 'yiyao', 'twoclassify', 'oneclassifyid', 1, 1, 'yiyao', 'classify', 'classifyid'),
('def', 'yiyao', 'PRIMARY', 'def', 'yiyao', 'users', 'userid', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-05-19 15:53:30', '2018-05-19 15:53:30', NULL, NULL, '', '', NULL),
...
('def', 'books', 'address', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-05-07 14:46:25', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'advertising', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2018-05-07 14:37:39', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'advertisingurl', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-05-07 14:39:03', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'books', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2018-05-07 14:11:50', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'booksimgurl', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-05-07 14:23:10', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'booksoneclassify', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2018-05-07 14:42:04', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'bookstwoclassify', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-05-07 14:43:04', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'cart', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-05-07 15:05:58', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2018-05-07 14:44:55', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'evaluate', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2018-05-07 14:34:02', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'orders', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2018-05-07 14:59:56', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'ordersmore', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2018-05-07 15:01:56', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'tag', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-05-07 14:21:05', NULL, NULL, NULL, '', '', NULL),
('def', 'books', 'versions', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-05-07 14:28:02', NULL, NULL, NULL, '', '', NULL),
('def', 'js1801', 'selected', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2018-04-26 09:10:48', NULL, NULL, NULL, '', '', NULL),
('def', 'js1801', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 0, '2018-04-25 20:13:35', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2010-12-04 02:18:58', '2010-12-24 11:00:30', '2010-12-04 02:19:04', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2010-12-04 02:19:03', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2010-12-04 02:19:01', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 453, 197, 89241, 55450570411999231, 16384, 0, '2010-12-04 02:19:01', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 992, 9, 8928, 2533274790395903, 18432, 0, '2010-12-04 02:19:01', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 505, 829, 418976, 281474976710655, 20480, 0, '2010-12-04 02:19:01', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2010-12-04 02:19:03', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2010-12-04 02:19:04', '2010-12-24 11:00:30', '2010-12-04 02:19:04', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 50, 200, 281474976710655, 2048, 0, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, NULL, '', '', NULL),
...
('def', 'taobao', 'goods', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19, 862, 16384, NULL, 0, 0, '2018-04-25 19:04:26', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'books', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2018-04-25 15:04:08', NULL, NULL, NULL, '', '', NULL),
('def', 'yiyao', 'classify', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 0, '2018-05-11 19:05:28', NULL, NULL, NULL, '', '', NULL),
('def', 'yiyao', 'ggimg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 16384, 0, '2018-05-15 09:44:22', NULL, NULL, NULL, '', '', NULL),
('def', 'yiyao', 'goods', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 16384, 0, '2018-05-15 09:35:22', NULL, NULL, NULL, '', '', NULL),
('def', 'yiyao', 'goodsimg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 16384, 0, '2018-05-15 09:38:19', NULL, NULL, NULL, '', '', NULL),
('def', 'yiyao', 'sanclassify', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2018-05-18 18:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'yiyao', 'twoclassify', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 1260, 16384, NULL, 16384, 0, '2018-05-11 19:06:16', NULL, NULL, NULL, '', '', NULL),
('def', 'yiyao', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2018-05-14 08:59:45', NULL, NULL, NULL, '', '', NULL);
...
(15, 'root', 'localhost:63454', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'books', 'acustomerid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'address', 'customer'),
('def', 'books', 'advertisingid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'advertisingurl', 'advertising'),
('def', 'books', 'booksid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'booksimgurl', 'books'),
('def', 'books', 'booksclassifyid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'bookstwoclassify', 'booksoneclassify'),
('def', 'books', 'cbooksid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'cart', 'books'),
('def', 'books', 'ebooksid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'evaluate', 'books'),
('def', 'books', 'eusersid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'evaluate', 'customer'),
('def', 'books', 'obookisid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'ordersmore', 'books'),
('def', 'books', 'oordersid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'ordersmore', 'orders'),
('def', 'books', 'bookid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'tag', 'books'),
('def', 'books', 'vbooksid', 'def', 'books', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'versions', 'books'),
('def', 'yiyao', 'goodsid', 'def', 'yiyao', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'ggimg', 'goods'),
('def', 'yiyao', 'imggoodsid', 'def', 'yiyao', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'goodsimg', 'goods'),
('def', 'yiyao', 'oneclassifyid', 'def', 'yiyao', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'twoclassify', 'classify');
...
('def', 'books', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'js1801', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'taobao', 'utf8', 'utf8_general_ci', NULL),
('def', 'test', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'yiyao', 'utf8', 'utf8_bin', NULL);
...
('HANDLER_READ_KEY', '188'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '0'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2454'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '12152'),
('INNODB_BUFFER_POOL_READS', '445'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '17'),
('INNODB_DATA_FSYNCS', '13'),
...
('def', 'books', 'address', 0, 'books', 'PRIMARY', 1, 'addressid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'address', 1, 'books', 'acustomerid', 1, 'customerid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'advertising', 0, 'books', 'PRIMARY', 1, 'advertisingid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'advertisingurl', 0, 'books', 'PRIMARY', 1, 'advertisingurlid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'advertisingurl', 1, 'books', 'advertisingid', 1, 'advertisingid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'books', 0, 'books', 'PRIMARY', 1, 'booksid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'booksimgurl', 0, 'books', 'PRIMARY', 1, 'imgurlid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'booksimgurl', 1, 'books', 'booksid', 1, 'booksid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'booksoneclassify', 0, 'books', 'PRIMARY', 1, 'booksoneclassifyid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'bookstwoclassify', 0, 'books', 'PRIMARY', 1, 'bookstwoclassifyid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'bookstwoclassify', 1, 'books', 'booksclassifyid', 1, 'booksoneid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'cart', 0, 'books', 'PRIMARY', 1, 'cartid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'cart', 1, 'books', 'cbooksid', 1, 'booksid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'customer', 0, 'books', 'PRIMARY', 1, 'customerid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'evaluate', 0, 'books', 'PRIMARY', 1, 'evaluateid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'evaluate', 1, 'books', 'ebooksid', 1, 'booksid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'evaluate', 1, 'books', 'eusersid', 1, 'usersid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'orders', 0, 'books', 'PRIMARY', 1, 'ordersid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'ordersmore', 0, 'books', 'PRIMARY', 1, 'ordersmoreid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'ordersmore', 1, 'books', 'obookisid', 1, 'booksid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'ordersmore', 1, 'books', 'oordersid', 1, 'ordersid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'tag', 0, 'books', 'PRIMARY', 1, 'tagid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'tag', 1, 'books', 'bookid', 1, 'bookid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'books', 'versions', 0, 'books', 'PRIMARY', 1, 'versionsid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'books', 'versions', 1, 'books', 'vbooksid', 1, 'booksid', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'js1801', 'selected', 0, 'js1801', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'js1801', 'user', 0, 'js1801', 'PRIMARY', 1, 'userid', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'taobao', 'goods', 0, 'taobao', 'PRIMARY', 1, 'goodsid', 'A', 19, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'books', 0, 'test', 'PRIMARY', 1, 'booksid', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'yiyao', 'classify', 0, 'yiyao', 'PRIMARY', 1, 'classifyid', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'yiyao', 'ggimg', 0, 'yiyao', 'PRIMARY', 1, 'ggimgid', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'yiyao', 'ggimg', 1, 'yiyao', 'goodsid', 1, 'ggimggoods', 'A', 7, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'yiyao', 'goods', 0, 'yiyao', 'PRIMARY', 1, 'goodsid', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'yiyao', 'goods', 1, 'yiyao', 'imgid', 1, 'imgid', 'A', 7, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'yiyao', 'goodsimg', 0, 'yiyao', 'PRIMARY', 1, 'imgid', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'yiyao', 'goodsimg', 1, 'yiyao', 'imggoodsid', 1, 'goodsid', 'A', 7, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'yiyao', 'sanclassify', 0, 'yiyao', 'PRIMARY', 1, 'sanclassifyid', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'yiyao', 'twoclassify', 0, 'yiyao', 'PRIMARY', 1, 'classifyid', 'A', 13, NULL, NULL, '', 'BTREE', '', ''),
('def', 'yiyao', 'twoclassify', 1, 'yiyao', 'oneclassifyid', 1, 'oneclassifyid', 'A', 2, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'yiyao', 'users', 0, 'yiyao', 'PRIMARY', 1, 'userid', 'A', 4, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
...
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
...
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-05-19 15:53:31', '2018-05-19 15:53:31', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
...
('def', 'books', 'address', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-05-07 14:46:25', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'advertising', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-05-07 14:37:39', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'advertisingurl', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-05-07 14:39:03', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'books', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-05-07 14:11:50', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'booksimgurl', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-05-07 14:23:10', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'booksoneclassify', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-05-07 14:42:04', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'bookstwoclassify', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-05-07 14:43:04', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'cart', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-05-07 15:05:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'customer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-05-07 14:44:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'evaluate', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, 1, '2018-05-07 14:34:02', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'orders', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-05-07 14:59:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'ordersmore', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, 1, '2018-05-07 15:01:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'tag', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-05-07 14:21:05', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'books', 'versions', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-05-07 14:28:02', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'js1801', 'selected', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 5242880, 5, '2018-04-26 09:10:48', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'js1801', 'user', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 5242880, 11, '2018-04-25 20:13:35', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2010-12-04 02:18:58', '2010-12-24 11:00:30', '2010-12-04 02:19:04', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2010-12-04 02:19:03', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2010-12-04 02:19:01', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 453, 197, 89241, 55450570411999231, 16384, 0, NULL, '2010-12-04 02:19:01', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 992, 9, 8928, 2533274790395903, 18432, 0, NULL, '2010-12-04 02:19:01', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 505, 829, 418976, 281474976710655, 20480, 0, NULL, '2010-12-04 02:19:01', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2010-12-04 02:19:03', '2010-12-24 11:00:30', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2010-12-04 02:19:04', '2010-12-24 11:00:30', '2010-12-04 02:19:04', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2010-12-04 02:19:02', '2010-12-24 11:00:30', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 50, 200, 281474976710655, 2048, 0, NULL, '2010-12-04 02:18:59', '2010-12-24 11:00:30', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'taobao', 'goods', 'BASE TABLE', 'InnoDB', 10, 'Compact', 19, 862, 16384, 0, 0, 5242880, 20, '2018-04-25 19:04:26', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'test', 'books', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 5242880, NULL, '2018-04-25 15:04:08', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'yiyao', 'classify', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 5242880, 11, '2018-05-11 19:05:28', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'yiyao', 'ggimg', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 16384, 5242880, 8, '2018-05-15 09:44:22', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'yiyao', 'goods', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 16384, 5242880, 8, '2018-05-15 09:35:22', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'yiyao', 'goodsimg', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 16384, 5242880, 8, '2018-05-15 09:38:19', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'yiyao', 'sanclassify', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 5242880, 7, '2018-05-18 18:25:44', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'yiyao', 'twoclassify', 'BASE TABLE', 'InnoDB', 10, 'Compact', 13, 1260, 16384, 0, 16384, 5242880, 14, '2018-05-11 19:06:16', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'yiyao', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 5242880, 11, '2018-05-14 08:59:45', NULL, NULL, 'utf8_bin', NULL, '', '');
...
('def', 'books', 'PRIMARY', 'books', 'address', 'PRIMARY KEY'),
('def', 'books', 'acustomerid', 'books', 'address', 'FOREIGN KEY'),
('def', 'books', 'PRIMARY', 'books', 'advertising', 'PRIMARY KEY'),
('def', 'books', 'PRIMARY', 'books', 'advertisingurl', 'PRIMARY KEY'),
('def', 'books', 'advertisingid', 'books', 'advertisingurl', 'FOREIGN KEY'),
('def', 'books', 'PRIMARY', 'books', 'books', 'PRIMARY KEY'),
('def', 'books', 'PRIMARY', 'books', 'booksimgurl', 'PRIMARY KEY'),
('def', 'books', 'booksid', 'books', 'booksimgurl', 'FOREIGN KEY'),
('def', 'books', 'PRIMARY', 'books', 'booksoneclassify', 'PRIMARY KEY'),
('def', 'books', 'PRIMARY', 'books', 'bookstwoclassify', 'PRIMARY KEY'),
('def', 'books', 'booksclassifyid', 'books', 'bookstwoclassify', 'FOREIGN KEY'),
('def', 'books', 'PRIMARY', 'books', 'cart', 'PRIMARY KEY'),
('def', 'books', 'cbooksid', 'books', 'cart', 'FOREIGN KEY'),
('def', 'books', 'PRIMARY', 'books', 'customer', 'PRIMARY KEY'),
('def', 'books', 'PRIMARY', 'books', 'evaluate', 'PRIMARY KEY'),
('def', 'books', 'ebooksid', 'books', 'evaluate', 'FOREIGN KEY'),
('def', 'books', 'eusersid', 'books', 'evaluate', 'FOREIGN KEY'),
('def', 'books', 'PRIMARY', 'books', 'orders', 'PRIMARY KEY'),
('def', 'books', 'PRIMARY', 'books', 'ordersmore', 'PRIMARY KEY'),
('def', 'books', 'obookisid', 'books', 'ordersmore', 'FOREIGN KEY'),
('def', 'books', 'oordersid', 'books', 'ordersmore', 'FOREIGN KEY'),
('def', 'books', 'PRIMARY', 'books', 'tag', 'PRIMARY KEY'),
('def', 'books', 'bookid', 'books', 'tag', 'FOREIGN KEY'),
('def', 'books', 'PRIMARY', 'books', 'versions', 'PRIMARY KEY'),
('def', 'books', 'vbooksid', 'books', 'versions', 'FOREIGN KEY'),
('def', 'js1801', 'PRIMARY', 'js1801', 'selected', 'PRIMARY KEY'),
('def', 'js1801', 'PRIMARY', 'js1801', 'user', 'PRIMARY KEY'),
...
('def', 'taobao', 'PRIMARY', 'taobao', 'goods', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'books', 'PRIMARY KEY'),
('def', 'yiyao', 'PRIMARY', 'yiyao', 'classify', 'PRIMARY KEY'),
('def', 'yiyao', 'PRIMARY', 'yiyao', 'ggimg', 'PRIMARY KEY'),
('def', 'yiyao', 'goodsid', 'yiyao', 'ggimg', 'FOREIGN KEY'),
('def', 'yiyao', 'PRIMARY', 'yiyao', 'goods', 'PRIMARY KEY'),
('def', 'yiyao', 'PRIMARY', 'yiyao', 'goodsimg', 'PRIMARY KEY'),
('def', 'yiyao', 'imggoodsid', 'yiyao', 'goodsimg', 'FOREIGN KEY'),
('def', 'yiyao', 'PRIMARY', 'yiyao', 'sanclassify', 'PRIMARY KEY'),
('def', 'yiyao', 'PRIMARY', 'yiyao', 'twoclassify', 'PRIMARY KEY'),
('def', 'yiyao', 'oneclassifyid', 'yiyao', 'twoclassify', 'FOREIGN KEY'),
('def', 'yiyao', 'PRIMARY', 'yiyao', 'users', 'PRIMARY KEY');
...
--
-- 转存表中的数据 `INNODB_LOCKS`
--

--
-- 数据库: `js1801`
--
CREATE DATABASE `js1801` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `js1801`;
...
INSERT INTO `selected` (`id`, `cont`) VALUES
(1, '你好'),
(2, '你是谁'),
(3, '你是我的小苹果'),
(4, '你不知道的事');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `uearpassword` varchar(40) NOT NULL,
...
INSERT INTO `user` (`userid`, `uearpassword`, `username`, `useremail`) VALUES
(6, '123456', 'zhangsan', '754297918@qq.com'),
(7, '123456', '123', '123456@163.com'),
(8, '123456', '123', '123456@163.com'),
(9, '123456', '1234', '123456@163.com'),
(10, '11123', '111', '312312');
--
-- 数据库: `mysql`
--
...
--
-- 表的结构 `time_zone_transition_type`
--
...
--
-- 转存表中的数据 `time_zone_transition_type`
--
...
--
-- 表的结构 `events_waits_history_long`
--
...
--
-- 转存表中的数据 `events_waits_history_long`
--
...
--
-- 表的结构 `events_waits_summary_by_instance`
--
...
--
-- 转存表中的数据 `events_waits_summary_by_instance`
--
...
--
-- 表的结构 `events_waits_summary_by_thread_by_event_name`
--
...
--
-- 转存表中的数据 `events_waits_summary_by_thread_by_event_name`
--
...
--
-- 表的结构 `events_waits_summary_global_by_event_name`
--
...
--
-- 转存表中的数据 `events_waits_summary_global_by_event_name`
--
...
--
-- 表的结构 `file_summary_by_event_name`
--
...
--
-- 转存表中的数据 `file_summary_by_event_name`
--
...
--
-- 转存表中的数据 `file_summary_by_instance`
--
...
CREATE TABLE IF NOT EXISTS `goods` (
  `goodsid` tinyint(1) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `goods` (`goodsid`, `goodsname`, `goodsprice`, `goodspic`, `goodssales`) VALUES
(1, '奥林巴斯E-PL8 14-42EZ 自拍微单 E-PL8 14-42 40-150双镜头 EPL9', 4870, 'https://gd4.alicdn.com/imgextra/i4/37351838/TB2mJA0ql0kpuFjy1zdXXXuUVXa_!!37351838.jpg', 345),
(2, '奥林巴斯/Olympus 75mm/f1.8镜头75 1.8 人像镜头 75mmF1.8镜头', 3900, 'https://gd1.alicdn.com/imgextra/i1/331420636/TB23jbQc7fb_uJkSmLyXXcxoXXa_!!331420636.jpg', 34),
(3, '富士GFX 50S 中画幅无反相机 GF32-64mm F4 镜头 GF120MM F4镜头', 44500, 'https://gd4.alicdn.com/imgextra/i4/37351838/TB2dp7EkodnpuFjSZPhXXbChpXa_!!37351838.jpg_400x400.jpg', 67),
(4, 'Nikon/尼康D5300 18-55镜头套机 入门级单反照相机 高清数码 旅游', 5000, 'https://gd2.alicdn.com/imgextra/i2/2032640357/TB2gMMoegvD8KJjy0FlXXagBFXa_!!2032640357.jpg_400x400.jpg_.webp', 654),
(5, '佳能EOS 80D单机 18-135USM套机 中端单反相机 高清数码 旅游', 6000, 'https://gd2.alicdn.com/imgextra/i2/2032640357/TB24PMRhvDH8KJjy1XcXXcpdXXa_!!2032640357.jpg', 234),
(6, '现货 佳能5D3单机身 EOS 5D Mark III 套机 全画幅专业单反相机', 11400, 'https://gd1.alicdn.com/imgextra/i1/687304109/TB2W0kKg_JYBeNjy1zeXXahzVXa_!!687304109.jpg', 342),
(7, 'Sony/索尼相机 ILCE-A6000L 16-50 单套机微单升级版A6300L A6500', 7370, 'https://gd1.alicdn.com/imgextra/i1/82524297/TB27XQJaaLN8KJjSZFKXXb7NVXa_!!82524297.jpg', 53),
(8, '奥林巴斯E-M1 MARK II 微单 EM1 二代 EM1 MARK II 12 40 2.8', 15000, 'https://gd2.alicdn.com/imgextra/i2/37351838/TB29_RobJ0opuFjSZFxXXaDNVXa_!!37351838.jpg', 533),
(9, '【大象摄影】Canon/佳能 80D 18-135套机中高端专业数码单反相机', 8000, 'https://gd3.alicdn.com/imgextra/i2/103209408/TB2.gVras5fF1Jjy0FlXXbtcXXa_!!103209408.jpg', 22),
(10, '佳能 EF 24-70mm f/2.8L II USM 镜头 24-70 f 2.8 二代 国行正品', 8900, 'https://gd2.alicdn.com/imgextra/i2/260225611/TB2KXXThFGWBuNjy0FbXXb4sXXa_!!260225611.jpg', 3455),
(11, 'Nikon/尼康 COOLPIX S7000 s7000 20倍光学变焦长焦相机 行货', 1224, 'https://gd1.alicdn.com/imgextra/i3/2/TB1c8osHpXXXXbEXVXXXXXXXXXX_!!2-item_pic.png_400x400.jpg', 233),
(12, 'Nikon/尼康 COOLPIX W300s 水下相机四防潜水4K高清数码防水相机', 2399, 'https://img.alicdn.com/imgextra/i3/3015124561/TB2XbqqjL6H8KJjSspmXXb2WXXa_!!3015124561.jpg_430x430q90.jpg', 453),
(13, 'Nikon/尼康 COOLPIX P900s 83倍长焦高清数码照相机尼康P900现货', 4480, 'https://gd4.alicdn.com/imgextra/i4/66753804/TB2uRyZXEUIL1JjSZFrXXb3xFXa_!!66753804.jpg', 98),
(14, 'Nikon/尼康 D810 单机 24-120 24-70 套机 单反相机专业全画幅', 18500, 'https://gd2.alicdn.com/imgextra/i2/316983842/TB2sDr6kkfb_uJjSsrbXXb6bVXa_!!316983842.jpg', 324),
(15, '尼康 AF-S 24-70 mm f2.8 G ED 单反镜头24-70 VR 二代 2.8E 正品', 13000, 'https://gd3.alicdn.com/imgextra/i4/0/TB1vgKuHFXXXXX9XVXXXXXXXXXX_!!0-item_pic.jpg', 23),
(16, '【下单立减】Canon/佳能微单EOS M50 15-45套机佳能美颜自拍相机', 6310, 'https://gd2.alicdn.com/imgextra/i2/103209408/TB2ZL4IbH3nBKNjSZFMXXaUSFXa_!!103209408.jpg_400x400.jpg_.webp', 43),
(17, '国行正品Canon/佳能PowerShot SX620 HS佳能长焦数码相机高清数码摄像机高清专业家用相机迷你旅游复古傻瓜', 1759, 'https://gd3.alicdn.com/imgextra/i3/2946615803/TB2T4OObbZnBKNjSZFrXXaRLFXa_!!2946615803.jpg', 24),
(18, 'Fujifilm/富士 instax mini70拍立得一次成像 香港行货 正品包邮', 867, 'https://gd2.alicdn.com/imgextra/i2/823422841/TB2t68nffjM8KJjSZFyXXXdzVXa_!!823422841.jpg', 423),
(19, '富士拍立得WIDE300宽幅相机复古W300立拍得5寸instax210套餐', 800, 'https://gd2.alicdn.com/imgextra/i2/169520047/TB2lDGyd98mpuFjSZFMXXaxpVXa_!!169520047.jpg', 34);
--
-- 数据库: `test`
--
...
CREATE TABLE IF NOT EXISTS `books` (
  ...
  `booksname` varchar(20) NOT NULL,
  `booksprice` float NOT NULL,
  `booksclass` varchar(20) NOT NULL,
  `booksinfo` varchar(200) NOT NULL,
  PRIMARY KEY (`booksid`)
...
INSERT INTO `books` (`booksid`, `booksname`, `booksprice`, `booksclass`, `booksinfo`) VALUES
(1, '开心死了', 20.3, '文学', '开心死了');
--
-- 数据库: `yiyao`
--
...
CREATE TABLE IF NOT EXISTS `sanclassify` (
  `sanclassifyid` tinyint(4) unsigned NOT NULL AUTO_INCREMENT,
  `classifyname` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `twoclassifyid` tinyint(4) unsigned DEFAULT NULL,
  PRIMARY KEY (`sanclassifyid`)
...
INSERT INTO `sanclassify` (`sanclassifyid`, `classifyname`, `twoclassifyid`) VALUES
(1, '阳痿早泄', 1),
(2, '男性不育症', 1),
(3, '前列腺炎', 1),
(4, '肾病', 1),
